...
app.use(express.static(__dirname + "/web/views/contact"))
app.use(express.static(__dirname + "/web/views/services"))
app.use(express.static(__dirname + "/web/views/chat"))
app.use(express.static(__dirname + "/web/views/mine"))
app.use(express.static(__dirname + "/web/views/about"))
...
app.listen(3001, "localhost", function () {
  ...
  // 这个语句可以自动调用浏览器运行项目
  cp.exec("start http://localhost:3001/login");
})
